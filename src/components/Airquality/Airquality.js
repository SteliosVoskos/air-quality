...
import { AirqualityValuesContainer, Container, Indicator, IndicatorValue, PollutantName, PollutantValue, PollutantLink, StationName, TrasparentLayer, AirQualityContainer } from './Airquality.styles';
